...
namespace BT
{
    ...
    class IsEnemyDead : public BehaviorNodeDecorator<boss, IActionNode>
    {
    public:
        IsEnemyDead(ICompositeNode* parent) : BehaviorNodeDecorator<boss, IActionNode>(parent)
        {
        }
